import {
  ...
  getAppointmentsByBusinessIdAndDate 
...
export const rescheduleAppointmentService = async (id, newTime) =>
  await rescheduleAppointment(id, newTime);

export const getAppointmentsForBusinessByDate = async (businessId, date) => {
  return await getAppointmentsByBusinessIdAndDate(businessId, date);
};
